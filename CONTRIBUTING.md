# Contributing to kleys

Thank you for considering contributing to kleys! Before diving in, please read these guidelines carefully.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/kleys.git
   ```
3. **Create a branch** with a descriptive name:
   ```bash
   git checkout -b fix/secrets-file-permissions
   # or
   git checkout -b feat/export-mode
   ```
...
5. **Make your changes** and validate before pushing:
   ...
   ```
   This runs lint, format check, tests, and type checking.
...
Every contribution makes a real difference. Thank you for taking the time to improve kleys.
